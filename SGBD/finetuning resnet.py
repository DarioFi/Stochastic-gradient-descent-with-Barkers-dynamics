...
if __name__ == '__main__':
    ...
    # main.main(True, std_model, dataset=DS, write_logs=True, epochs=EPOCHS, alfa_target=1 / 10)
    # train_mod, opt = main.main(True, pre_trained_model, dataset=DS, write_logs=True, epochs=3, alfa_target=1 / 4)
    # gg = lambda x: train_mod
    # main.main(False, gg, dataset=DS, write_logs=True, epochs=20, alfa_target=1 / 10)
