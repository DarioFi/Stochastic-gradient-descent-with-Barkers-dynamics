...
if __name__ == '__main__':
    ...
    main.main(True, std_model, dataset=DS, global_stepsize=.1, write_logs=True, epochs=E, alfa_target=1 / 10)
    main.main(True, std_model, dataset=DS, global_stepsize=.5, write_logs=True, epochs=E, alfa_target=1 / 10)
    main.main(True, std_model, dataset=DS, global_stepsize=.05, write_logs=True, epochs=E, alfa_target=1 / 10)
